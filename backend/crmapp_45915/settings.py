"""
Django settings for crmapp_45915 project.
...
ROOT_URLCONF = 'crmapp_45915.urls'
...
WSGI_APPLICATION = 'crmapp_45915.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "crmapp_45915 API",
    "DESCRIPTION": "API documentation for crmapp_45915 App",
    "VERSION": "v1",
}
